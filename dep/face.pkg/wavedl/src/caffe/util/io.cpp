...
//added by sunlinjun for loading model from memory
bool ReadProtoFromText(const char* pText, Message* proto) {
...
bool ReadProtoFromBinaryMemory(void* buffer, int size, Message* proto) {
  CodedInputStream* coded_input = new CodedInputStream((google::protobuf::uint8*) buffer, size);
